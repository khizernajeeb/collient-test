...
class BatsmenListing extends Component {
  ...
  render() {
    console.log('batsman', this.state, this.props);
    ...
    const batsmenColumns = [
      ...
      },
      {
        ...
        render: dataIndex => (dataIndex === 'R' ? 'Right Handed' : 'Left Handed'),
        filters: [{ text: 'Right Handed', value: 'R' }, { text: 'Left Handed', value: 'L' }],
        filteredValue: filteredInfo.batsman_arm || null,
